...
BasicGame.GameFinal = function (game) {
...
BasicGame.GameFinal.prototype = {
    ...
    create: function () {
        ...
        this.scoreText = this.game.add.text( 650, 15, "Score: " + this.score, style );
        this.scoreText.anchor.setTo( 0.5, 0.0 );

        this.lifeCountText = this.game.add.text( 650, 30, "Lives: " + this.lifeCount, style );
    ...
    update: function () {
        ...
        // new trajectory.
        if(this.lifeCount > 0 && this.score < 20)
        {
        ...
        else if (this.score >= 10)
        {
          ...
          this.time.events.add(Phaser.Timer.SECOND * 6, this.quitGameWin, this);
        }
    },
    ...
    incomingBooks: function(){
      ...
      if(this.game.time.now > this.respawnBookTime)
      {
        ...
        this.book.reset((this.game.rnd.integerInRange(100, 700)), 10);
        this.book.body.velocity.y = 400;
        ...
        if (this.game.time.now > this.shootTime)
        {
          ...
          //  console.log(this.fireBall);
            ...
            //{
                ...
                this.fireBall.body.velocity.y = -400;
                this.shootTime = this.game.time.now + 300;
            //}
        }

    },

    quitGameWin: function(){
      this.state.start('Diploma');
    },
