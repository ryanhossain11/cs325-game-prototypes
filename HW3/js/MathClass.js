...
BasicGame.MathClass = function (game) {
...
BasicGame.MathClass.prototype = {
    ...
    create: function () {
        ...
        this.mathClass = this.game.add.sprite(this.game.world.centerX, this.game.world.centerY, 'mathclass');
        this.mathClass.anchor.setTo(0.5, 0.5);
    ...
    enterMathClass: function()
    {
      ...
      if((this.boy.x < 490 && this.boy.x > 340) && (this.boy.y > 400 && this.boy.y < 490) && this.up.isDown)
      {
        this.startFinal();
      }
    },
