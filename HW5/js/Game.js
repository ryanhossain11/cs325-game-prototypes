...
BasicGame.Game.prototype = {
    ...
    update: function () {
        ...
        // new trajectory.
        if(this.lifeCount > 0 && this.score <= 10)
        {
        ...
        {
          var style = { font: "25px Verdana", fill: "#000000", align: "center" };
          var winText = this.game.add.text( this.game.world.centerX, this.game.world.centerY, "Stage 1 complete!", style );

          winText.anchor.setTo( 0.5, 0.0 );
          this.time.events.add(Phaser.Timer.SECOND * 2, this.nextStage, this);
        }
    },

    tip: function(){
      var style = { font: "25px Verdana", fill: "#000000", align: "center" };
      this.tipText = this.game.add.text( this.game.world.centerX, this.game.world.centerY, "Stage 1! Destroy 10 books", style );
    ...
    movePlayer: function(){
      if(this.left.isDown && (this.skyChar.x - 5 > 0))
      {
        this.skyChar.x -= 5;
      }
      if(this.right.isDown && (this.skyChar.x + 5 < 600))
      {
        this.skyChar.x += 5;
      }
    },
    ...
    incomingBooks: function(){
      ...
      if(this.game.time.now > this.respawnBookTime)
      {
        ...
        this.respawnBookTime = this.game.time.now + 500;
      }
    },
