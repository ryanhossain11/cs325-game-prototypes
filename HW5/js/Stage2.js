...
BasicGame.Stage2.prototype = {
    ...
    update: function () {
        ...
        {
          var style = { font: "25px Verdana", fill: "#000000", align: "center" };
          var winText = this.game.add.text( this.game.world.centerX, this.game.world.centerY, "Stage 2 complete", style );

          winText.anchor.setTo( 0.5, 0.0 );

          this.time.events.add(Phaser.Timer.SECOND * 3, this.nextStage, this);
        }
    },

    tip: function(){
      var style = { font: "25px Verdana", fill: "#000000", align: "center" };
      this.tipText = this.game.add.text( this.game.world.centerX, this.game.world.centerY, "Stage 2! DESTROY 20 books!", style );
